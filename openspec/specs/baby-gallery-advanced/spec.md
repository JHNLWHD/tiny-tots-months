# baby-gallery-advanced Specification

## Purpose

Baby gallery and related month views support caption search, persisted favorites (with optimistic cache UX), compare-two mode, and server-backed loading for large libraries.

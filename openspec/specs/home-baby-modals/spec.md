# home-baby-modals Specification

## Purpose

Home Add Baby and Edit Baby dialogs: one modal at a time, reliable open/close with Radix Dialog + Select stacking, Strict Mode–safe behavior, and no dead clicks after dismiss.

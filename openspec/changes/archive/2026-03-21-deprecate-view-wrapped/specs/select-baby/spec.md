...
### Requirement: Wrapped stats tied to baby selection documentation

**Reason:** The Wrapped feature is deprecated; selected baby no longer drives a Wrapped-specific recap surface in the product.

**Migration:** Use the home timeline, per-month pages, and gallery to view photos and milestones for the selected baby.

      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Card className="mb-8 shadow-md">
          ...
          <CardContent className="space-y-4 text-left">
            ...
            <p>
              At Tiny Tots Milestones ("we", "our", or "us"), we respect your privacy and are committed to protecting the personal information 
              you share with us. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our 
            ...
            <p>
              ...
              stored in secure cloud databases, and media files are stored with unique identifiers to prevent 
              unauthorized access.
            </p>
            
            <h2 className="text-xl font-semibold text-gray-800 mt-6">5. Sharing Your Information</h2>
            <p>
              We do not sell or rent your personal information to third parties. Your data is only shared when:
            </p>
            <ul className="list-disc pl-6 space-y-2 mt-2">
              <li>You explicitly choose to share content via our sharing features</li>
              <li>Required by law or to protect our rights</li>
              <li>With service providers who assist us in operating our website and services (all bound by confidentiality agreements)</li>
            </ul>
            
            <h2 className="text-xl font-semibold text-gray-800 mt-6">6. Your Rights</h2>
            <p>
              You have the right to access, correct, or delete your personal information. You can manage most of this 
              directly within your account settings, or contact us for assistance.
            </p>
            
            <h2 className="text-xl font-semibold text-gray-800 mt-6">7. Children's Privacy</h2>
            <p>
              Our service is designed for parents and guardians to document their children's development. We do not knowingly 
              collect information directly from children under 13. All child data is managed by parents or legal guardians.
            </p>

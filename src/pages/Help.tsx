...
import { Book, HelpCircle, Info, LifeBuoy } from "lucide-react";
			...
			<div className="max-w-4xl mx-auto">
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
					<Card className="shadow-md hover:shadow-lg transition-shadow">
						...
						<CardContent>
							<p className="mb-4">
								Comprehensive guides on how to make the most of Tiny Tots
								Milestones.
							</p>
					...
					<Card className="shadow-md hover:shadow-lg transition-shadow">
						...
						<CardContent>
							<p className="mb-4">
								Find solutions to the most frequently asked questions about our
								platform.
							</p>
					...
					<CardContent>
						<Accordion type="single" collapsible className="w-full">
							<AccordionItem value="item-1">
								<AccordionTrigger>
									How do I create a baby profile?
								</AccordionTrigger>
								<AccordionContent>
									To create a baby profile, log in to your account and navigate
									to the dashboard. Click on "Add Baby" button and fill in your
									baby's details including name, date of birth, and an optional
									photo. Click "Save" to create the profile. Free accounts can
									create one baby profile, while premium accounts can create
									unlimited profiles.
								</AccordionContent>
							</AccordionItem>
							...
							<AccordionItem value="item-2">
								...
								<AccordionContent>
									Navigate to the month view for your baby by selecting your
									baby's profile and clicking on the specific month. In the
									Photos section, click on "Upload Photos" button. You can
									select multiple photos or videos from your device. Each file
									can be up to 25MB in size. You can also add optional captions
									to each media item.
								</AccordionContent>
							</AccordionItem>
							...
							<AccordionItem value="item-5">
								...
								<AccordionContent>
									To upgrade, go to your account settings or click on the
									"Upgrade" button in the dashboard. Follow the instructions to
									submit your payment proof. Our team will verify your payment
							...
							<AccordionItem value="item-6">
								<AccordionTrigger>
									Can I delete photos or milestones after adding them?
								</AccordionTrigger>
								<AccordionContent>
									Yes, you can delete both photos and milestones. For photos, go
									to the month view and hover over the photo you want to delete.
									Click on the delete icon and confirm. For milestones, go to
									the milestone section and click on the delete button next to
									the milestone you want to remove.
								</AccordionContent>
							</AccordionItem>

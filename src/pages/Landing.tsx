...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="bg-white py-16" id="problem-solution" aria-labelledby="why-heading">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 id="why-heading" className="text-3xl font-bold mb-4">Why Tiny Tots Milestones?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <article className="bg-baby-pink/10 p-8 rounded-xl text-center">
              <div className="bg-baby-pink/20 inline-flex p-3 rounded-full mb-4">
                <CheckCircle2 className="h-6 w-6 text-baby-pink" aria-hidden="true" />
              </div>
          ...
          <div className="space-y-12 max-w-4xl mx-auto">
            <article className="flex flex-col md:flex-row gap-8 items-center">
              ...
              <div className="md:w-1/2 bg-baby-purple/5 p-4 rounded-xl">
                <figure className="aspect-video bg-baby-purple/20 rounded-lg flex items-center justify-center">
                  <figcaption className="text-baby-purple">Milestone Tracker Screenshot</figcaption>
                </figure>
              </div>
            </article>
            ...
            <article className="flex flex-col md:flex-row-reverse gap-8 items-center">
              ...
              <div className="md:w-1/2 bg-baby-pink/5 p-4 rounded-xl">
                <figure className="aspect-video bg-baby-pink/20 rounded-lg flex items-center justify-center">
                  <figcaption className="text-baby-pink">Photo Gallery Screenshot</figcaption>
                </figure>
              </div>
            </article>
            ...
            <article className="flex flex-col md:flex-row gap-8 items-center">
              ...
              <div className="md:w-1/2 bg-baby-blue/5 p-4 rounded-xl">
                <figure className="aspect-video bg-baby-blue/20 rounded-lg flex items-center justify-center">
                  <figcaption className="text-baby-blue">Sharing Features Screenshot</figcaption>
                </figure>
              </div>
            </article>
            ...
            <article className="flex flex-col md:flex-row-reverse gap-8 items-center">
              ...
              <div className="md:w-1/2 bg-baby-mint/5 p-4 rounded-xl">
                <figure className="aspect-video bg-baby-mint/20 rounded-lg flex items-center justify-center">
                  <figcaption className="text-baby-mint">PDF Export Preview</figcaption>
                </figure>
              </div>
            </article>
          </div>
      ...
      <section className="bg-white py-16" id="pricing" aria-labelledby="pricing-heading">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {/* Free Plan */}
            <article className="border border-gray-200 rounded-xl p-8 bg-white shadow-sm hover:shadow-md transition-shadow">
            ...
            {/* Premium Plan */}
            <article className="border-2 border-baby-purple rounded-xl p-8 bg-white shadow-md relative overflow-hidden">
              ...
              <ul className="space-y-3 mb-8">
                {[
                  ...
                  <li key={item} className="flex items-start">
                    <CheckCircle2 className="h-5 w-5 text-baby-purple mr-2 mt-0.5 flex-shrink-0" aria-hidden="true" />
                    <span>{item}</span>
                  </li>
                ))}
              </ul>

...
export const useSubscription = () => {
  ...
  const createSubscription = useMutation({
    ...
    onSuccess: () => {
      ...
      toast.success("Your subscription creation request has been submitted! Free access is now available.");
    },
    onError: (error) => {
      console.error("Error creating subscription:", error);
      toast.error(`Subscription creation request failed: ${error.message || 'Please try again later'}`);
    },
  })

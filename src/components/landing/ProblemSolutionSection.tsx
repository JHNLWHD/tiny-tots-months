...
const ProblemSolutionSection = () => {
	return (
		<section
			className="bg-gradient-to-b from-white to-gray-50 py-12 sm:py-16 md:py-20"
			id="problem-solution"
			aria-labelledby="why-heading"
		>
			<div className="w-full px-4 sm:px-6 lg:px-8">
				<div className="max-w-6xl mx-auto text-center mb-10 sm:mb-12 md:mb-16">
					<h2 id="why-heading" className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6 text-gray-800 px-2">
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 max-w-7xl mx-auto">
					<article className="royal-blue-card-gradient p-6 sm:p-8 md:p-10 rounded-2xl text-center shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 border border-baby-purple/10">
						<div className="bg-baby-purple/10 inline-flex p-3 sm:p-4 rounded-full mb-4 sm:mb-6 shadow-md">
							<Camera className="h-6 w-6 sm:h-8 sm:w-8 text-baby-purple" aria-hidden="true" />
						</div>
						<h3 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 text-gray-800">Organized Memories</h3>
					...
					<article className="royal-blue-card-gradient p-6 sm:p-8 md:p-10 rounded-2xl text-center shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 border border-baby-purple/10">
						<div className="bg-baby-purple/10 inline-flex p-3 sm:p-4 rounded-full mb-4 sm:mb-6 shadow-md">
							<CheckCircle2
								className="h-6 w-6 sm:h-8 sm:w-8 text-baby-purple"
								aria-hidden="true"
							/>
						</div>
						<h3 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 text-gray-800">Track Development</h3>
						<p className="text-sm sm:text-base text-gray-600 leading-relaxed">
